...
public class DataDBHelper extends SQLiteOpenHelper {
    ...
    public ArrayList<String> databasetoString(Context ctx) {
        String dbString = "", file_str = "Pressure,\t Velocity,\t Duration\n";
    ...
    private void writeToFile(String data, Context ctx) {
        try {
            ...
            if (sd.canWrite()) {
                String currentDBPath = "//data//research.sg.edu.edapp.kb//databases//" + DATABASE_NAME;
                //File home=new File(sd,"//Shakeyboard//DataFiles//");
                String backupDBPath = "//AffectSense//DataFiles//";
